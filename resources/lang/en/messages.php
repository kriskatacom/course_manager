...
return [
    ...
    "role_name_required" => "The role key is required.",
    "role_name_string"   => "The role key must be a string.",
    "role_name_max"      => "The role key may not be greater than :max characters.",
